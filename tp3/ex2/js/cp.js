...
/* Il est tout de même conseillé d'utiliser du JSON*/
  ...
  loupe.addEventListener("click",(ev) => {
    ...
    promesse.then( // On demarre la promesse
      function(valeuretour) { /* FONCTION RESOLVE*/
        ...
        /*FICHIER TXT */
        /*var decodevaleuretour = valeuretour;
        var champs = decodevaleuretour.split(",");*/
        /*FICHIER XML*/
        /*var parser = new DOMParser();
        var xmlDoc = parser.parseFromString(valeuretour, "application/xml");
        var champs = [];
        champs[0] = xmlDoc.getElementsByTagName("ville")[0].textContent;
        champs[1] = xmlDoc.getElementsByTagName("departement")[0].textContent;*/
        /*FICHIER JSON*/
